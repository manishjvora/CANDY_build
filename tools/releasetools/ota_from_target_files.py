...
""" % bcb_dev)
  ...
  script.Print("************************************************************");
  script.Print("************************************************************");
  script.Print("   ____                 _       _____                       ");
  script.Print("  / ___|               | |     |  __ \                      ");
  script.Print(" | |     __ _ _ __   __| |_   _| |__| |___  _ __ ___   ___  ");
  script.Print(" | |    / _` | '_ \ / _` | | | |  _  // _ \| '_ ` _ \ / __| ");
  script.Print(" | |___| |_| | | | | |_| | |_| | | \ \ |_| | | | | | |\__ \ ");
  script.Print("  \____|\__,_|_| |_|\__,_|\__, |_|  \_\___/|_| |_| |_||___/ ");
  script.Print("                           __/ |                            ");
  script.Print("                          |___/                             ");
  script.Print("                                                            ");
